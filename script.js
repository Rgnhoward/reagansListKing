...
I added missing () to "updateCount" line #58 -RH
#################################################*/
  ...
  $newItemForm.on("submit", function (e) {
    ...
    var text = $("input:text").val().toLowerCase(); // Get value of text input

    //if ('li':contains $(this).val()){
    //$(this).remove();

    var defaultClass = "favorite";
    $list
      .append("<li class=" + defaultClass + ">" + text + "</li>")
      .add("favorite"); // Add item to end of the list
...
a heart icon)"
	...
	best - don't hardcode in the class name, make it a variable. #DID THIS#
-BC 

I chained .addClass(favorite) to line# 53 and added a default class- RH
#################################################*/
...
better - add in at least SOME of the code to execute your plan ##DID THIS##
...
I attempted to code this, but syntax or positioning is incorrect.
Inserted at line# 48-49, but commented out to keep functionality -RH
#################################################*/
